...
<head>
    ...
    <title>Latihan Form Belanja</title>
</head>
<body style="background-color: #2ECC71;">
    <div class="bg-danger"><br>
    ...
    <div class="col-6">
        ...
        <div class="form-group row">
            ...
            <button name="submit" type="submit" class="btn btn-dark">Kirim</button>
            </div>
        </div>
        </form>
    </div>
    <div class="card border-secondary mb-3" style="max-width: 18rem;">
        <div class="text-white text-center card-header bg-dark border-dark">Daftar Harga</div>
        <div class="card-body">
            <p class="card-text">TV : 4.200.000</p><hr>
            <p class="card-text">Kulkas : 3.100.000</p><hr>
            <p class="card-text">Mesin Cuci : 3.800.000</p>
        </div>
    <div class="text-white text-center card-footer bg-dark border-dark">Harga dapat berubah setiap saat</div>
    </div>
    </div>
    <div class="m-5 border border-dark p-4 rounded">
        <?php
            ...
            <?php if(isset($_POST['submit'])){?>
                ...
                <?php }else{
                    echo '<div class="alert alert-warning" role="alert"> Silahkan Isi Form Diatas Untuk Menampilkan Struk Belanja</div>';
                } ?>
    </div>
</body>
</html>